...
def generate_config(context):
    ...
    gateway_Uri=generate_gateway_uri(project_id,context.env['region'],context.env['gatewayname'])
    ...
    if context.properties['type']=='HA':
        ...
        resources.extend([
            {
             ...
             {
                # HA VPN external gateway resource.
        ...
        resources.extend([
            ...
            },
            {
                ...
                'properties':
                    {
                        'name': '{}-esp'.format(target_vpn_gateway),
                        'project': project_id,
            ...
            },
            {
                ...
                'properties':
                    {
                        'name': '{}-udp-4500'.format(target_vpn_gateway) ,
                        'project': project_id,
                        'IPAddress': ip_address,
                        'IPProtocol': 'UDP',
                        'portRange': 4500,
            ...
            },
            {
                ...
                'properties':
                    {
                        'name': '{}-udp-500'.format(target_vpn_gateway) ,
                        'project': project_id,
                        'IPAddress': ip_address,
                        'IPProtocol': 'UDP',
                        'portRange': 500,
